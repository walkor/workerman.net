...
App\Common\Protocols\Http\header('Allow: POST');
App\Common\Protocols\Http\header('HTTP/1.1 405 Method Not Allowed');
...
wp_safe_redirect( $location );App\Common\Protocols\Http\jump_exit();
