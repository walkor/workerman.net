...
App\Common\Protocols\Http\header('Content-Type: '.get_bloginfo('html_type').'; charset='.get_bloginfo('charset'));
...
App\Common\Protocols\Http\setcookie(TEST_COOKIE, 'WP Cookie check', 0, COOKIEPATH, COOKIE_DOMAIN);
...
<?php	App\Common\Protocols\Http\jump_exit();
		}
