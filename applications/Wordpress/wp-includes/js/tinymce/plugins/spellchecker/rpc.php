...
App\Common\Protocols\Http\header('Content-Type: text/plain');
App\Common\Protocols\Http\header('Content-Encoding: UTF-8');
App\Common\Protocols\Http\header("Expires: Mon, 26 Jul 1997 05:00:00 GMT");
App\Common\Protocols\Http\header("Last-Modified: " . gmdate("D, d M Y H:i:s") . " GMT");
App\Common\Protocols\Http\header("Cache-Control: no-store, no-cache, must-revalidate");
App\Common\Protocols\Http\header("Cache-Control: post-check=0, pre-check=0", false);
...
// No input data
if (!$raw)
App\Common\Protocols\Http\jump_exit('{"result":null,"id":null,"error":{"errstr":"Could not get raw post data.","errfile":"","errline":null,"errcontext":"","level":"FATAL"}}');
...
App\Common\Protocols\Http\jump_exit('{"result":null,"id":null,"error":{"errstr":"You must choose an spellchecker engine in the config.php file.","errfile":"","errline":null,"errcontext":"","level":"FATAL"}}');
