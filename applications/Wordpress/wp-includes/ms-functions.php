...
function install_blog($blog_id, $blog_title = '') {
	...
	App\Common\Protocols\Http\jump_exit( '<h1>' . __( 'Already Installed' ) . '</h1><p>' . __( 'You appear to have already installed WordPress. To reinstall please clear your old database tables first.' ) . '</p></body></html>' );
