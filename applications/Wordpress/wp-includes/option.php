...
function wp_user_settings() {
	...
	App\Common\Protocols\Http\setcookie( 'wp-settings-' . $user_id, $settings, time() + YEAR_IN_SECONDS, SITECOOKIEPATH );
	App\Common\Protocols\Http\setcookie( 'wp-settings-time-' . $user_id, time(), time() + YEAR_IN_SECONDS, SITECOOKIEPATH );
 ...
 * This function has to be used before any output has started as it calls App\Common\Protocols\Http\setcookie().
 *
 * @package WordPress
 * @subpackage Option
 * @since 2.8.0
...
function delete_all_user_settings() {
	...
	App\Common\Protocols\Http\setcookie('wp-settings-' . $user_id, ' ', time() - YEAR_IN_SECONDS, SITECOOKIEPATH);
}
