...
function wp_ajax_wp_compression_test() {
	...
	if ( isset($_GET['test']) ) {
	App\Common\Protocols\Http\header( 'Expires: Wed, 11 Jan 1984 05:00:00 GMT' );
	App\Common\Protocols\Http\header( 'Last-Modified: ' . gmdate( 'D, d M Y H:i:s' ) . ' GMT' );
	App\Common\Protocols\Http\header( 'Cache-Control: no-cache, must-revalidate, max-age=0' );
