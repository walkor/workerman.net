...
App\Common\Protocols\Http\header( 'Content-Description: File Transfer' );
App\Common\Protocols\Http\header( 'Content-Disposition: attachment; filename=' . $filename );
App\Common\Protocols\Http\header( 'Content-Type: text/xml; charset=' . get_option( 'blog_charset' ), true );
