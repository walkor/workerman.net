...
class WP_List_Table {
	...
	App\Common\Protocols\Http\jump_exit( 'function WP_List_Table::ajax_user_can() must be over-ridden in a sub-class.' );
	}
	...
	App\Common\Protocols\Http\jump_exit( 'function WP_List_Table::prepare_items() must be over-ridden in a sub-class.' );
	}
...
<?php
	...
	App\Common\Protocols\Http\jump_exit( 'function WP_List_Table::get_columns() must be over-ridden in a sub-class.' );
	}
...
<?php
	...
	App\Common\Protocols\Http\jump_exit( json_encode( $response ) );
	}
