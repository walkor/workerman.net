		...
		<div class="col-md-5 column text-center">
			...
			<div class="thumbnail">
				<div class="caption-download">
					...
					<a class="btn btn-default btn-large" href="https://github.com/walkor/workerman-chat" target="_blank"><b>Fork on Github</b></a><p></p>
					<a class="btn btn-default btn-large" href="/download/chatzip">下载ZIP压缩文件 </a> <font class='f11 gray'>下载<?php echo $chat_download_count;?>次</font>
				</div>
			</div>
		</div>
	</div>
