<div class="row clearfix">
		<div class="col-md-9 column">
			...
			<p>
				workerman-thrift-rpc是一个以workerman作为服务器容器，使用<a href="http:/thrift.apache.org" target="_blank">thrift</a>协议及其传输层模块搭建起来的跨语言的RPC远程调用框架。
			</p>
			<p>
