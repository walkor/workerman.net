	...
	<div class="col-md-7 column">
		...
		<div class="media">
			...
			<div class="media-body">
				...
				<a target="_blank" class="btn" href="/workerman-todpole">详情 »</a>
...
" Ya "（好呀！） <br>
		...
		<div class="media">
			...
			<div class="media-body">
				...
				<a target="_blank" class="btn" href="/workerman-flappybird">详情 »</a>
		...
		<div class="media">
			...
			<div class="media-body">
				<h4 class="media-heading">
				 ...
				 <a target="_blank" class="btn" href="/workerman-thrift">详情 »</a>
		...
		<div class="media">
			...
			<div class="media-body">
				...
				<a target="_blank" class="btn" href="/workerman-chat">详情 »</a>
		...
		<div class="media">
			...
			<div class="media-body">
				...
				<a target="_blank" class="btn" href="/workerman-statistics">详情 »</a>
