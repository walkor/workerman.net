...
<div class="row clearfix">
		<div class="col-md-7 column">
			...
			<p>
			<h4><a href="http://browserquest.workerman.net/" target="_blank">线上DEMO效果点击这里</a></h4>
			</p>
			<h3>
				特性
			</h3>
	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<p>3、浏览器访问端口http://ip:8787或者http://域名:8787，例如<a href="http://browserquest.workerman.net">http://workerman.net:8787</a>如图：</p>
