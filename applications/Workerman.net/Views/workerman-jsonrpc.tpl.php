...
<div class="row clearfix">
	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<h3>配置</h3>
			<p>配置文件位置 ./applications/JsonRpc/conf.d/JsonRpcWorker.conf</p>
			<pre><code>
;Rpc网络服务应用配置
;所用的传输层协议及绑定的ip端口
...
preread_length=84000
			...
			<h3>workerman-json-rpc集成了统计监控模块，界面如下（地址：http://ip:55757 <a href="http://www.workerman.net:55757/" target="_blank">demo</a>）</h3>
