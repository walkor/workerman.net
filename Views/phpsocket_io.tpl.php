...
<div class="row clearfix">
		<div class="col-md-7 column">
			...
			<div class="thumbnail">
				<div class="caption-download">
					<h4>PHPSocket.IO</h4>
					<p></p><table><tbody><tr><td><iframe src="http://ghbtns.com/github-btn.html?user=walkor&amp;repo=phpsocket.io&amp;type=watch&amp;count=true&amp;size=large" height="30" width="170" frameborder="0" scrolling="0" style="width:150px; height: 30px;" allowtransparency="true"></iframe></td><td><iframe src="http://ghbtns.com/github-btn.html?user=walkor&amp;repo=phpsocket.io&amp;type=fork&amp;count=true&amp;size=large" height="30" width="170" frameborder="0" scrolling="0" style="width:150px; height: 30px;" allowtransparency="true"></iframe></td></tr></tbody></table><p></p>
					...
					<a class="btn btn-default btn-large" href="https://github.com/walkor/phpsocket.io/archive/master.zip"><b>下载ZIP压缩文件</b> </a> 
					<h4>Windows版本下载</h4>
					<a class="btn btn-default btn-large" href="https://github.com/walkor/phpsocket.io-for-win/archive/master.zip"><b>下载Win版本ZIP压缩文件</b> </a> 
				</div>
			</div>
	...
	<div class="row clearfix">
		<div class="col-md-8 column">
            ...
            <span class="pl-s1" style="box-sizing: border-box;">});</span><span class="pl-c1" style="box-sizing: border-box; color: rgb(0, 134, 179);">Worker</span><span class="pl-k" style="box-sizing: border-box; color: rgb(167, 29, 93);">::</span>runAll();</span></pre>
            </div>
            <p style="box-sizing: border-box; margin-top: 0px; margin-bottom: 16px; color: rgb(51, 51, 51); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Helvetica, Arial, sans-serif, &quot;Apple Color Emoji&quot;, &quot;Segoe UI Emoji&quot;, &quot;Segoe UI Symbol&quot;; font-size: 16px; line-height: 24px;">
            	客户端
            </p>
            <div class="highlight highlight-source-js" style="box-sizing: border-box; margin-bottom: 16px; color: rgb(51, 51, 51); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Helvetica, Arial, sans-serif, &quot;Apple Color Emoji&quot;, &quot;Segoe UI Emoji&quot;, &quot;Segoe UI Symbol&quot;; font-size: 16px; line-height: 24px;">
            	<pre style="box-sizing: border-box; font-family: Consolas, &quot;Liberation Mono&quot;, Menlo, Courier, monospace; font-size: 13.6px; margin-top: 0px; margin-bottom: 0px; font-stretch: normal; line-height: 1.45; word-wrap: normal; padding: 16px; overflow: auto; border-radius: 3px; word-break: normal; background-color: rgb(247, 247, 247);"><span class="pl-k" style="box-sizing: border-box; color: rgb(167, 29, 93);">&lt;</span>script src<span class="pl-k" style="box-sizing: border-box; color: rgb(167, 29, 93);">=</span><span class="pl-s" style="box-sizing: border-box; color: rgb(24, 54, 145);"><span class="pl-pds" style="box-sizing: border-box;">'</span>//cdn.bootcss.com/socket.io/1.3.7/socket.io.js<span class="pl-pds" style="box-sizing: border-box;">'</span></span><span class="pl-k" style="box-sizing: border-box; color: rgb(167, 29, 93);">&gt;&lt;</span><span class="pl-k" style="box-sizing: border-box; color: rgb(167, 29, 93);">/</span>script<span class="pl-k" style="box-sizing: border-box; color: rgb(167, 29, 93);">&gt;</span>
