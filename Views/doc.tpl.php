	...
	<li class="active">
		...
		<div class="media">
			<div class="media-body">
				...
				<br><a target="_blank" class="btn" href="http://doc.workerman.net/">在线手册 »</a> <a target="_blank" class="btn" href="http://doc3.workerman.net/">备用在线手册 »</a> 
				</p>
			</div>
		</div>
		<div class="media">
			<div class="media-body">
				...
				<br>
				<a class="btn" target="_blank" href="http://doc2.workerman.net/">GatewayWorker手册</a> <a target="_blank" class="btn" href="http://doc4.workerman.net/">备用在线手册2 »</a> 
				</p>
			</div>
		</div>
