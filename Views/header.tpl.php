...
<head>
  <meta charset="utf-8">
  <title><?php if(isset($html_title))echo $html_title;else echo 'workerman一个高性能PHPSocket服务器框架';?></title>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li<?php if($html_nav == 'related_projects')echo ' class="active" ';?>>
							<a href="https://www.workerman.net/related_projects" target="_blank">第三方项目</a>
						</li>
						<li>
