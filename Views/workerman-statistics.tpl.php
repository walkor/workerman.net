...
<div class="row clearfix">
	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<pre><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">require&nbsp;</span><span style="color: #DD0000">'yourpath/StatisticClient.php'</span><span style="color: #007700">;<br /></span><span style="color: #FF8000">//&nbsp;统计开始<br /></span><span style="color: #0000BB">StatisticClient</span><span style="color: #007700">::</span><span style="color: #0000BB">tick</span><span style="color: #007700">(</span><span style="color: #DD0000">"User"</span><span style="color: #007700">,&nbsp;</span><span style="color: #DD0000">'getInfo'</span><span style="color: #007700">);<br /></span><span style="color: #FF8000">//&nbsp;统计的产生，接口调用是否成功、错误码、错误日志<br /></span><span style="color: #0000BB">$success&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">true</span><span style="color: #007700">;&nbsp;</span><span style="color: #0000BB">$code&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">0</span><span style="color: #007700">;&nbsp;</span><span style="color: #0000BB">$msg&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #DD0000">''</span><span style="color: #007700">;<br /></span><span style="color: #FF8000">//&nbsp;假如有个User::getInfo方法要监控<br /></span><span style="color: #0000BB">$user_info&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">User</span><span style="color: #007700">::</span><span style="color: #0000BB">getInfo</span><span style="color: #007700">();<br />if(!</span><span style="color: #0000BB">$user_info</span><span style="color: #007700">){<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;标记失败<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$success&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">false</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;获取错误码，假如getErrCode()获得<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$code&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">User</span><span style="color: #007700">::</span><span style="color: #0000BB">getErrCode</span><span style="color: #007700">();<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;获取错误日志，假如getErrMsg()获得<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$msg&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">User</span><span style="color: #007700">::</span><span style="color: #0000BB">getErrMsg</span><span style="color: #007700">();<br />}<br /></span><span style="color: #FF8000">//&nbsp;上报结果<br /></span><span style="color: #0000BB">StatisticClient</span><span style="color: #007700">::</span><span style="color: #0000BB">report</span><span style="color: #007700">(</span><span style="color: #DD0000">'User'</span><span style="color: #007700">,&nbsp;</span><span style="color: #DD0000">'getInfo'</span><span style="color: #007700">,&nbsp;</span><span style="color: #0000BB">$success</span><span style="color: #007700">,&nbsp;</span><span style="color: #0000BB">$code</span><span style="color: #007700">,&nbsp;</span><span style="color: #0000BB">$msg</span><span style="color: #007700">);<br /></span></span></code></pre>
			<h3>服务端的使用</h3>
			<p>直接访问http://ip:55757便可以看到统计结果 (如果无法访问请检查服务器防火墙，如果是云服务器还要设置安全组)</p>
			<p>界面示例：<a href="http://demos.workerman.net:55757" target="_blank">demos.workerman.net:55757</a></p>
			<h3>界面截图</h3>
