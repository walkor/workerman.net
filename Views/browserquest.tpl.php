...
<div class="row clearfix">
		<div class="col-md-7 column">
			...
			<p>
			<h4><a href="http://demos.workerman.net/browserquest/" target="_blank">线上DEMO效果点击这里</a></h4>
			</p>
			<h3>
				特性
			</h3>
	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<p>2、Web/config/config_local.json里面的host改成本机ip或者域名</p>
			<p>3、linux用户进入目录并启动workerman<code>php start.php start -d</code>，windows用户双击start_for_win.bat。启动界面类似</p>
			<img src="/img/browserquest-start.png" alt="browserquest启动示意图"/>
			<p>4、浏览器访问端口http://ip:8787或者http://域名:8787，例如
